                ...
                <tbody>
                  ...
                  <tr>
                    <td style="padding: 10px 30px;">
                      "<p style="font-family: 'Work Sans', sans-serif; font-size: 14px; color: #555555; margin: 0;">
                      ...
                      <div style="background-color: #f9f9f9; padding: 15px; margin-top: 15px; border-radius: 8px;">
                        <p style="font-family: 'Work Sans', sans-serif; font-size: 14px; color: #333333; margin: 0; white-space: pre-wrap;">
                          ${body}
                        </p>
                      </div>
                    </td>
